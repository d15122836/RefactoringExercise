...
public class Menu extends JFrame{
	...
	public void menuStart()
	{
		  ...
		  if they are a new customer, or will ask them to log in if they are an existing customer or admin.*/
			...
			// Adding code to refactor
			
			createUserTypePanel("Existing Customer", "Customer", userTypePanel, userType, radioButton );
			createUserTypePanel("Administrator", "Administrator", userTypePanel, userType, radioButton);
			createUserTypePanel("New Customer", "New Customer", userTypePanel, userType, radioButton);
			/*
						...
						add.addActionListener(new ActionListener() {
							public void actionPerformed(ActionEvent e) {
							    ...
							    ArrayList<CustomerAccount> accounts = new ArrayList<CustomerAccount> ();
										...
										showMessageDialog("CustomerID = " + CustomerID +"\n Password = " + password  ,"Customer created.");
	...
	public void admin()
	{
		...
		JButton deleteCustomer = createJButton("Delete Customer");
		JPanel deleteCustomerPanel  = createJPanel( deleteCustomer);
		JButton deleteAccount = new JButton("Delete Account");
		JPanel deleteAccountPanel =  createJPanel(deleteAccount);
		JButton bankChargesButton = new JButton("Apply Bank Charges");
		JPanel bankChargesPanel = createJPanel(bankChargesButton);
		JButton interestButton = new JButton("Apply Interest");
		JPanel interestPanel  = createJPanel(interestButton);
		JButton editCustomerButton = new JButton("Edit existing Customer");
		JPanel editCustomerPanel = createJPanel(editCustomerButton);
		JButton navigateButton = new JButton("Navigate Customer Collection");
		JPanel navigatePanel = createJPanel(navigateButton);
		JButton summaryButton = new JButton("Display Summary Of All Accounts");
		JPanel summaryPanel = createJPanel(summaryButton);
		JButton accountButton = new JButton("Add an Account to a Customer");
		JPanel accountPanel  = createJPanel(accountButton);
	...
	//	content.add(deleteAccountPanel);
		...
		bankChargesButton.addActionListener(new ActionListener(  ) {
			public void actionPerformed(ActionEvent ae) {
				...
				{
					showMessageDialog("There are no customers yet!"  ,"Oops!");
			    ...
			    else
			    {
					...
					continueButton.addActionListener(new ActionListener(  ) {
						public void actionPerformed(ActionEvent ae) {
							...
							showMessageDialog("25" + euro + " deposit account fee aplied."  ,"");
							...
							showMessageDialog( "New balance = " + acc.getBalance() ,"Success!");
							...
							showMessageDialog("15" + euro + " current account fee aplied."  ,"");
					...
					continueButton.addActionListener(new ActionListener(  ) {
						public void actionPerformed(ActionEvent ae) {
							...
							if(isNumeric(interestString))
							{
								...
								showMessageDialog(interest + "% interest applied. \n new balance = " + acc.getBalance() + euro ,"Success!");
							...
							{
								showMessageDialog("You must enter a numerical value!" ,"Oops!");
		...
		navigateButton.addActionListener(new ActionListener(  ) {
			public void actionPerformed(ActionEvent ae) {
				...
				JButton first, previous, next, last, cancel, accountNumber, surname;
			...
			/*	firstNameLabel = new JLabel("First Name:", SwingConstants.LEFT);
				...
				accountNumber = new JButton("Find by Account Number");
				surname = new JButton("Find by Surname");
			...
			/*	gridPanel.add(firstNameLabel);
				...
				accountNumber.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent arg0) {
					    ...
					    while(loop) {
						  Object accountNumber = JOptionPane.showInputDialog(f, "Account Number of Customer You Wish to display:");
						    
						    for (Customer aCustomer: customerList){
						    	
						    	if(!aCustomer.getAccounts().isEmpty()) {
						    		for(CustomerAccount customerAccount : aCustomer.getAccounts() ) {
						    			if(customerAccount.getNumber().equals(accountNumber)) {
						    		found = true;
						    		customer = aCustomer; 	
						    	}	
						    		}
				...
				surname.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent arg0) {
					    ...
					    while(loop) {
						  Object aSurname = JOptionPane.showInputDialog(f, "Surname of Customer You Wish to display:");
						    
						    for (Customer aCustomer: customerList){
						    	
						    	if(aCustomer.getSurname().equals(aSurname)) {
						    		found = true;
						    		customer = aCustomer; 	
						    	}	
						    		}
			...
			public void actionPerformed(ActionEvent ae) {
			    ...
			    else
			    {
				    ...
				    case ("Current Account"):
				    {
				    	...
				    	showMessageDialog("Account number = " + number +"\n PIN = " + pin  ,"Account created.");
				    ...
				    case ("Deposit Account"):
				    {
				    	...
				    	showMessageDialog( "Account number = " + number ,"Account created.");
				...
				{
					 {
						    ...
						    else
						    {
						    	...
						    	{
						    		showMessageDialog("This customer has accounts. \n You must delete a customer's accounts before deleting a customer " ,"Oops!");
						    	...
						    	else
						    	{
						    		...
						    		showMessageDialog("Customer Deleted " ,"Success.");
	...
	{	
		...
		if(e == null ||  e.getAccounts() == null  || e.getAccounts().size() == 0) 
			
		
		{
			showMessageDialog("This customer does not have any accounts yet. \n An admin must create an account for this customer \n for them to be able to use customer functionality. " ,"Oops!");
		...
		JPanel statementPanel  = createJPanel( statementButton); 
		
		JButton lodgementButton = new JButton("Lodge money into account");
		JPanel lodgementPanel  = createJPanel( lodgementButton);
		
		JButton withdrawButton = new JButton("Withdraw money from account");
		JPanel withdrawalPanel  = createJPanel( withdrawButton);
		
		JButton returnButton = new JButton("Exit Customer Menu");
		JPanel returnPanel  = createJPanel( returnButton);
		...
		lodgementButton.addActionListener(new ActionListener(  ) {
			...
			if(acc instanceof CustomerCurrentAccount)
			{
				...
				while(loop)
				{
					if(count == 0)
					{
						showMessageDialog("Pin entered incorrectly 3 times. ATM card locked."  ,"Pin");
				   ...
				   if(on)
				   {
					...
					{
						loop = false;
						showMessageDialog("Pin entry successful" ,  "Pin");
					...
					{
						count --;
						showMessageDialog("Incorrect pin. " + count + " attempts remaining." ,  "Pin");
			...
			// String date = new SimpleDateFormat("yyyyMMdd_HHmmss").format(Calendar.getInstance().getTime());
			 ...
			 String type = "Lodgement";
				...
				showMessageDialog(balance + euro + " added do you account!" ,"Lodgement");
				showMessageDialog(balance + euro + " added do you account!" ,"Lodgement");
		...
		withdrawButton.addActionListener(new ActionListener(  ) {
			...
			//		String date = new SimpleDateFormat("yyyyMMdd_HHmmss").format(Calendar.getInstance().getTime());
				 ...
				 // Reusing methods
					...
					showMessageDialog(withdraw + euro + " withdrawn." ,"Withdraw");
					showMessageDialog("New balance = " + acc.getBalance() + euro ,"Withdraw");
...
public void createUserTypePanel(String radioButtonLabel, String actionCommand, JPanel userTypePanel, ButtonGroup userType, JRadioButton radioButton) {
	userTypePanel.add(radioButton = new JRadioButton(radioButtonLabel));
...
public JPanel createJPanel( JButton jButton) {
JPanel jPanel = new JPanel(new FlowLayout(FlowLayout.LEFT));
jPanel.add(jButton);
return jPanel;
}

public JButton createJButton(String buttonName) {
	JButton jButton = new JButton(buttonName);	
	jButton.setPreferredSize(new Dimension(250, 20));
	return jButton;
}
...
private void createTextFields(JPanel gridPanel) {
	firstNameLabel = new JLabel("First Name:", SwingConstants.LEFT);
	surnameLabel = new JLabel("Surname:", SwingConstants.LEFT);
	pPPSLabel = new JLabel("PPS Number:", SwingConstants.LEFT);
	dOBLabel = new JLabel("Date of birth", SwingConstants.LEFT);
